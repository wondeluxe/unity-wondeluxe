...
{
	/// <summary>
	/// Provides access utility methods implemented in <c href="https://github.com/Unity-Technologies/UnityCsReference/blob/master/Editor/Mono/ScriptAttributeGUI/ScriptAttributeUtility.cs">UnityEditor.ScriptAttributeUtility</c>, as well as additional related methods.
	/// </summary>
	...
	public static class ScriptAttributeUtilityExtensions
	{
		...
		private static readonly object[] getDrawerTypeForTypeParams = new object[1];
		...
		/// <param name="fieldInfo">FieldInfo to get the custom PropertyDrawers for.</param>
		/// <param name="propertyDrawers">The output argument that will contain the PropertyDrawers.</param>
		/// <returns><c>true</c> if any PropertyDrawers were found, otherwise <c>false</c>.</returns>

		//public static bool TryGetDrawers(FieldInfo fieldInfo, List<PropertyDrawer> propertyDrawers)
		//{
		...
		//	return (propertyDrawers.Count > 0);
		//}
